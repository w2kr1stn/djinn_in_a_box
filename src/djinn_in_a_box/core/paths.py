"""Path constants and utilities for Djinn in a Box CLI.

Configuration paths use the ~/.config/ convention. Utilities for
resolving mount paths used in Docker container operations.
"""
