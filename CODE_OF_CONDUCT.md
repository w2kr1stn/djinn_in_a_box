...
Examples of representing the community include using an official project account,
...
reported through the private reporting channel described in `SECURITY.md`.
