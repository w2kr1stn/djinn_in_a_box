...
## Database
- **Supabase**: For inspection of data and data models use the Supabase MCP (via Docker MCP Gateway)
...
## Git Commits
- **Exclude**: `TASKS.md`, `PROJECT.md` / `FEATURE.md`, `SESSION*.md` & this particular `GEMINI.md` file
